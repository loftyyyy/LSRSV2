    ...
    function renderTable(reservations) {
        ...
        reservations.forEach(function(reservation) {
            ...
            var actionButtonHtml = isPending
                ? '<button type="button" onclick="openEditReservationModal(' + reservation.reservation_id + ')" class="rounded-lg p-1.5 hover:bg-violet-600 hover:text-white transition-colors duration-300 ease-in-out" aria-label="Edit pending reservation" title="Edit reservation"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-3.5 w-3.5"><path fill="none" d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"/></svg></button>'
                : '<button type="button" aria-disabled="true" tabindex="-1" class="group relative rounded-lg p-1.5 text-neutral-400 dark:text-neutral-600 cursor-not-allowed" aria-label="Edit disabled" title="' + disabledEditTitle + '"><span class="relative inline-flex items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-3.5 w-3.5"><path fill="none" d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"/></svg><span class="absolute inset-0 flex items-center justify-center pointer-events-none"><span class="block w-5 border-t-2 border-current rotate-[-35deg] opacity-90"></span></span></span></button>';
